...
new_app_sql = """create table if not exists {} (
  ...
  pull_request      VARCHAR(100)    not null,
...
insert_com_sql = """INSERT INTO {} (title,repository,pull_request,user,id,issue_num,comments,labels,state,created,updated,closed,body)
VALUES ('{}','{}','{}','{}',{},{},{},'{}','{}',###,###,###,'{}');""".replace("###", datetime_cov)

select_app_sql = """SELECT title,repository,pull_request,user,id,issue_num,comments,labels,state,
...
def get_header():
    return ["title", "repository", "pull request", "requester", "id", "issue_num", "label", "comments", "state", "create day", "update day",
            "close day", "body"]
...
class ISSuedb:
    def __init__(self, filepath='issue.db'):
